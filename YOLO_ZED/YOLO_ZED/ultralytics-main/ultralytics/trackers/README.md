...
model = YOLO("path/to/best_8n_200_1000.pt")  # Load a custom trained model
...
yolo track model=path/to/best_8n_200_1000.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained model

# Track using ByteTrack tracker
yolo track model=path/to/best_8n_200_1000.pt tracker="bytetrack.yaml"
```
