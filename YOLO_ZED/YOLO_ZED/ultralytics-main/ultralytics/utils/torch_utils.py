...
def strip_optimizer(f: Union[str, Path] = "best_8n_200_1000.pt", s: str = "") -> None:
    """
    Strip optimizer from 'f' to finalize training, optionally save as 's'.

    Args:
        f (str): file path to model to strip the optimizer from. Default is 'best_8n_200_1000.pt'.
    ...
    def __call__(self, epoch, fitness):
        ...
        if stop:
            LOGGER.info(
                ...
                f"Best results observed at epoch {self.best_epoch}, best model saved as best_8n_200_1000.pt.\n"
