...
model = torch.hub.load('ultralytics/yolov5', 'custom', path='path/to/best_8n_200_1000.pt')  # local model
model = torch.hub.load('path/to/yolov5', 'custom', path='path/to/best_8n_200_1000.pt', source='local')  # local repo
```
