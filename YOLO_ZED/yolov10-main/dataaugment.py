...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='img1')
    parser.add_argument('--source_xml_path', type=str, default='xml1')
    parser.add_argument('--save_img_path', type=str, default='img1_1')
    parser.add_argument('--save_xml_path', type=str, default='xml1_1')
